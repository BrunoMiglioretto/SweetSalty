											...
											<form method="POST" action="">
												<div class="col-sm-12">
													...
													<div class="row">
														...
														<div class="col-sm-4 form-group">
															<label>Senha</label>
															<input title="Senha" type="password" placeholder="Senha" name="Senha"  class="form-control" required>
														</div>	
														<div class="col-sm-4 form-group">
													...
													<center>
														<input title="Salvar" type="submit" name="salvar" value="Salvar" class='btn btn-primary' style='width: 100px;'>				
													</center>
												</div>
											</form>
										</div>
