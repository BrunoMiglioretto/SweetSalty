								...
								<div class="col-sm-12">
									...
									<div class="row">
										...
										<div class="col-12 col-lg-4 col-sm-6 form-group">
											...
											<input type="text" name="numeroTelefone" placeholder="Ex: (41) 99999-9999" class="form-control" required value="<?= $cliente->getDdd().$cliente->getNumeroTelefone()?>" maxlenght="15">
										</div>
