        ...
        <div class="content-wrapper" class='print'>	
            <div class="container-fluid" class='print'>
                <div class="card-header">
                    <a href="Inserir_Produto.php"><button type="button" class="btn btn-primary" left>Novo</button></a>
                </div>	
...
<!---------------------------------------FIM CONTEUDO--------------------------------------->
		...
		<a class="scroll-to-top rounded" style="z-index: 15;" href="#page-top">
