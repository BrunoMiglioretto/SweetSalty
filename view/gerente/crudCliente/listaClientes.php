...
<html lang="PT-BR">
    <head>
        ...
        <title>Cliente | Sweet Salty</title>
    ...
    <body id="page-top">
        ...
        <div class="content-wrapper" class='print'> 
            <div class="container-fluid" class='print'>
                <div class="card-header">       
                    <a href="crudCliente/novoCliente.php"><button type="button" class="btn btn-primary">Novo</button></a>
                </div>
            ...
            <div class='modal-dialog modal-dialog-centered' role='document'>
                <div class='modal-content'>
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='campo'>
                            <p><b>Data de nascimento:</b></p><input type='date' id="dataNascimento" disabled>
                        </div>
                        <div class='campo'>
                            <p><b>Sexo:</b></p><input type='text' id="sexo" disabled>
                        </div>
                    </div>
                    <div class='modal-footer'>
        ...
        <script>
            ...
            function atualizarTabela() {
                $.ajax({
                    url : "../../controller/gerenteController/crudClienteController/visualizarClientesController.php"
                }).done(function(n) {
                    $("tbody").html(n);
                });
            }
            ...
            function maisDados(idCadastro) {
                ...
                $("#data de nascimento").val(dado.data.dataNasc);
                $("#sexo").val(dado.data.sexo);
