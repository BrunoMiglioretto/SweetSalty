...
<html lang="PT-BR">
	...
	<body id="page-top">
		...
		<!-------------------------------------------CONTEUDO--------------------------------------->
		<!-------------------------------------------CONTEUDO--------------------------------------->
		<br><br><br><center><h1 style="font-family: 'Raleway', sans-serif; font-size:50px; color:#F15821;">Salgados</h1></center>
												  ...
												  <div class="card" style="background:#71A149;">
												    ...
												    <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
												      <div class="card-body">
																		<?php
																			include "../Funcoes/conexao.php";
																			$sql = "SELECT * FROM tb_cardapio WHERE cardapio_cat = 'Salgado' and cardapio_subcategoria = 'Coxinha' order by cardapio_desc asc";
												  ...
												  <div class="card" style="background:#71A149;">
												    ...
												    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
												      <div class="card-body">
																<?php
																			include "../Funcoes/conexao.php";
																			$sql = "SELECT * FROM tb_cardapio WHERE cardapio_cat = 'Salgado' and cardapio_subcategoria = 'Pastel' order by cardapio_desc asc";
																			$listar = $fusca -> prepare($sql);
																			$listar -> execute();
												  ...
												  <div class="card" style="background:#71A149;">
												    ...
												    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
												      <div class="card-body">
												      	 <?php
																			include "../Funcoes/conexao.php";
																			$sql = "SELECT * FROM tb_cardapio WHERE cardapio_cat = 'Salgado' and cardapio_subcategoria = 'Sanduíche' order by cardapio_desc asc";
																			$listar = $fusca -> prepare($sql);
																			$listar -> execute();
												  ...
												  <div class="card" style="background:#71A149;">
												    ...
												    <div id="collapseTw" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
												      <div class="card-body">
																<?php
																			include "../Funcoes/conexao.php";
																			$sql = "SELECT * FROM tb_cardapio WHERE cardapio_cat = 'Salgado' and cardapio_subcategoria = 'Empada' order by cardapio_desc asc";
																			$listar = $fusca -> prepare($sql);
																			$listar -> execute();
