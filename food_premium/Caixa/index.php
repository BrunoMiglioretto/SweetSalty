										...
										if($id_cliente == $id_armazenado){
											...
											echo "
												<tr>
													...
													<td>".number_format($troco_armazenado, 2, ',', ' ')."</td>
													<td><a href='../Garcom/historico.php?id_cliente=$id_armazenado'><img src='../img/Finalizado.png'></a></td>
												</tr>
											";	
											$total = 0;
											$id_armazenado = $id_cliente;
										...
										if($qtd_linhas == 1){
											...
											echo "
												<tr>
													...
													<td>$pagamento</td>
													<td>R$".number_format($total, 2, ',', ' ')."</td>
													<td>".number_format($troco, 2, ',', ' ')."</td>
													<td><a href='../Garcom/historico.php?id_cliente=$id_cliente'><img src='../img/Finalizado.png'></a></td>
												</tr>
											";	
										}
										$v++;
