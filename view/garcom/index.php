<?php
	include "../../controller/garcomController/verificacaoSessionGarcomController.php";
		...
		<script>
			...
			function pegarPedidos(){
				tabela = $("#tabela").DataTable({
					...
					"ajax" : {
						"method" : "POST",
						"url" : "../../controller/garcomController/visualizarPedidosController.php"
					},
					columns: [
						{ data : 'vez'},
						{ data : 'nome'},
			...
			function marcarComoPronto(){
				$.ajax({
					url : "../../controller/garcomController/marcarComoEntregueController.php",
					method : "POST",
					data : {
					...
					tabela.ajax.reload();
					alertify.notify("Marcado como entregue", "success");
				});
			}
			...
			function guardarIdCardapio(idCardapioSelecionado, idPedidoSelecionado, nome){
				...
				titulo = "Entregue " + nome.toLowerCase();
				mensagem = `Marcar como entregue o pedido de ${nome}?`;
