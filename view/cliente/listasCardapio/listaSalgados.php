...
<html lang="PT-BR">
	<head>
        ...
        <title>Cardápio de Salgados | Sweet Salty</title>
	...
	<body id="page-top">
		...
		<br><br><br>
		<center>
			<h1 style="font-family: 'Raleway', sans-serif; font-size:50px; color:#F15821;" class="trn">Salgados</h1>
		</center>
                                    ...
                                    <div id="accordion">
                                        <div class="card" style="background:#71A149;">
                                            <div class="card-header" id="headingSix" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix"> 
                                                <h5 class="mb-0">
                                                    <button style="color:#fff; font-size:20px;" class="btn btn-link collapsed trn" data-toggle="collapse"  aria-expanded="false" >Coxinha</button>
                                                </h5>
                                            </div>
                                            <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
                                                <div class="card-body">
                                                    <?php
														$coxinha = Cardapio::visualizarAlimentos("Coxinha");
                                                        foreach($coxinha as $cardapio){
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h4 class="modal-title" id="myModalLabel"><?php echo " Adicionar <input class='input' type='text' disabled name='cardapio_cat' value='$cardapio_cat' readonly='readonly' style='width:220px; border: 1px solid transparent;background-color: transparent;'/>&nbsp "?></h4>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <?php echo "<input class='input' type='text' disabled name='cardapio_desc' value='$cardapio_desc' readonly='readonly' style='width:220px; border: 1px solid transparent;background-color: transparent;'/>&nbsp R$<input class='input' type='text' disabled name='cardapio_valor' style='width:80px; border:0px; background-color: transparent;' readonly='readonly'value=' $cardapio_valor'/>"?>
                                                                                    <p style="float:right;">
										...
										<div class="card" style="background:#71A149;">
											<div class="card-header" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
												<h5 class="mb-0">
													<button style="color:#fff; font-size:20px;" class="btn btn-link collapsed trn" data-toggle="collapse"  aria-expanded="false">Pastel Assado</button>
												</h5>
											</div>
											<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
												<div class="card-body">
													<?php	
														$pastel = Cardapio::visualizarAlimentos('Pastal Assado');	
														foreach($pastel as $cardapio){
															$cardapio_id		         = $cardapio["id_cardapio"];
                                                            $cardapio_desc               = $cardapio["nome"];
                                                            $cardapio_valor              = $cardapio["valor_unitario"];
                                                            $cardapio_subcategoria       = $cardapio["nome_cardapio_subcat"];
																		...
																		<div class="modal fade" id="myModal<?php echo $cardapio_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
																			<div class="modal-dialog">
																				<div class="modal-content">
																					...
																					<div class="modal-body">
																						<?php echo "<input class='input' type='text' disabled name='cardapio_desc' value='$cardapio_desc' readonly='readonly' style='width:220px; border: 1px solid transparent;background-color: transparent;'/>&nbsp 
										...
										<div class="card" style="background:#71A149;">
											<div class="card-header" id="headingThree" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
												<h5 class="mb-0">
													<button style="color:#fff; font-size:20px;" class="btn btn-link collapsed trn" data-toggle="collapse"  aria-expanded="false" >Sanduíche Natural</button>
												</h5>
											</div>
											<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
												<div class="card-body">
													<?php
														$sanduiche = Cardapio::visualizarAlimentos('Sanduiche Natural');
														foreach($sanduiche as $cardapio){
															$cardapio_id                 = $cardapio["id_cardapio"];
                                                            $cardapio_desc               = $cardapio["nome"];
                                                            $cardapio_valor              = $cardapio["valor_unitario"];
                                                            $cardapio_subcategoria       = $cardapio["nome_cardapio_subcat"];
										...
										<div class="card" style="background:#71A149;">
											<div class="card-header" id="headingTwo" data-toggle="collapse" data-target="#collapseTw" aria-expanded="false" aria-controls="collapseTwo">
												<h5 class="mb-0">
													<button style="color:#fff; font-size:20px;" class="btn btn-link collapsed trn" data-toggle="collapse"  aria-expanded="false">Empada</button>
												</h5>
											</div>
											<div id="collapseTw" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
												<div class="card-body">
													<?php
														$empada = Cardapio::visualizarAlimentos('Empada');			
														foreach($empada as $cardapio){
															$cardapio_id                 = $cardapio["id_cardapio"];
                                                            $cardapio_desc               = $cardapio["nome"];
                                                            $cardapio_valor              = $cardapio["valor_unitario"];
                                                            $cardapio_subcategoria       = $cardapio["nome_cardapio_subcat"];
